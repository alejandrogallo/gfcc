#ifndef TAMM_GF_DIIS_CS_HPP_
#define TAMM_GF_DIIS_CS_HPP_
...
inline void ret_gf_diis_a(ExecutionContext& ec, const TiledIndexSpace& MO, int ndiis,
                      Tensor<std::complex<T>>& e1_a,
                      Tensor<std::complex<T>>& e2_aaa,  Tensor<std::complex<T>>& e2_bab,
                      Tensor<std::complex<T>>& xx1_a,
                      Tensor<std::complex<T>>& xx2_aaa, Tensor<std::complex<T>>& xx2_bab,
                      Tensor<std::complex<T>>& x1_a, 
                      Tensor<std::complex<T>>& x2_aaa,  Tensor<std::complex<T>>& x2_bab,
                      const TiledIndexSpace& diis_tis,
...
inline void ret_gf_diis_b(ExecutionContext& ec, const TiledIndexSpace& MO, int ndiis,
                      Tensor<std::complex<T>>& e1_b,
                      Tensor<std::complex<T>>& e2_bbb,  Tensor<std::complex<T>>& e2_aba,
                      Tensor<std::complex<T>>& xx1_b,
                      Tensor<std::complex<T>>& xx2_bbb, Tensor<std::complex<T>>& xx2_aba,
                      Tensor<std::complex<T>>& x1_b, 
                      Tensor<std::complex<T>>& x2_bbb,  Tensor<std::complex<T>>& x2_aba,
                      const TiledIndexSpace& diis_tis,
                      const TiledIndexSpace& unit_tis, bool opt=false){
...
inline void adv_gf_diis_a(ExecutionContext& ec, const TiledIndexSpace& MO, int ndiis,
                      Tensor<std::complex<T>>& e1_a,
                      Tensor<std::complex<T>>& e2_aaa,  Tensor<std::complex<T>>& e2_bab,
                      Tensor<std::complex<T>>& yy1_a,
                      Tensor<std::complex<T>>& yy2_aaa, Tensor<std::complex<T>>& yy2_bab,
                      Tensor<std::complex<T>>& y1_a, 
                      Tensor<std::complex<T>>& y2_aaa,  Tensor<std::complex<T>>& y2_bab,
                      const TiledIndexSpace& diis_tis,
                      const TiledIndexSpace& unit_tis, bool opt=false){
...
inline void adv_gf_diis_b(ExecutionContext& ec, const TiledIndexSpace& MO, int ndiis,
                      Tensor<std::complex<T>>& e1_b,
                      Tensor<std::complex<T>>& e2_bbb,  Tensor<std::complex<T>>& e2_aba,
                      Tensor<std::complex<T>>& yy1_b,
                      Tensor<std::complex<T>>& yy2_bbb, Tensor<std::complex<T>>& yy2_aba,
                      Tensor<std::complex<T>>& y1_b, 
                      Tensor<std::complex<T>>& y2_bbb,  Tensor<std::complex<T>>& y2_aba,
                      const TiledIndexSpace& diis_tis,
                      const TiledIndexSpace& unit_tis, bool opt=false){
