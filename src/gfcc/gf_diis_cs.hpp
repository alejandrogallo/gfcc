 ...
 */
template<typename T>
inline void gf_diis(ExecutionContext& ec, const TiledIndexSpace& MO, int ndiis,
  ...
  sch.allocate(tmp)
    ...
    .deallocate(e1_conj_a,e2_conj_aaa,e2_conj_bab) //e1_conj_b,e2_conj_aba,e2_conj_bbb)
    .execute();
