...
if(NWX_CUDA)
    ...
    if(CMAKE_CUDA_COMPILER)
        ...
        # endforeach()
        set(CMAKE_CUDA_FLAGS "--maxrregcount 128 --use_fast_math -gencode arch=compute_${NWX_GPU_ARCH},code=sm_${NWX_GPU_ARCH}")
    endif()
endif()
...
function(add_mpi_cuda_unit_test __name __cudasrcs __np __testargs)
    ...
    nwchemex_set_up_cuda_target(${__name} ${__testcudalib} "" "" "tests")
    install(TARGETS ${__name} DESTINATION tests)
